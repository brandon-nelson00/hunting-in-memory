...
malware_analysis_lab02_repo/
├── images/              # Extracted figures from the lab PDF
│   ├── image-000.png    # Ping test (connectivity)
│   ├── image-001.png    # Nmap service scan
│   ├── image-002.png    # Anonymous FTP login
